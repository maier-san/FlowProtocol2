...
\Beispiel{14 Abschnittsverschiebung}
\begin{verbatim}
...
Die äußere \verb|~DoWhile|-Schleife wiederholt so lange, wie diese Zwischensumme noch kleiner als die Anzahl der zu verteilenden Aufgaben ist und noch ein Vorgang zum verteilen übrig ist, was über den Befehl \verb|~EvalExpression| getrennt ausgewertet und in der Variablen \verb|anybug| abgespeichert wird.
