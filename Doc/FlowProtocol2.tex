...
Das nachfolgende Quali-Maßnahmen\index{Quali-Maßnahmen}-Protokoll ist ähnlich aufgebaut wie Beispiel~\ref{BspPOAssi} und zeigt anhand der oben genannten Punkte, wie ein Entwickler seine Entwicklung durch zusätzliche Maßnahmen absichern kann, wenn sie diese Aspekte erfüllt.

\Beispiel{Quali-Maßnahmen}
\begin{verbatim}
?Q1: Umfasst die Entwicklung Funktionen, die Datensätze löschen?
    #j: Ja
        @Maßnahmen >> Löschen von Datensätzen:
...
?Q2: Umfasst die Entwicklung die Verwendung
    ...
    #j: Ja
        @Maßnahmen >> Verwendung von Drittkomponenten:
...
?Q3: Umfasst die Entwicklung die Verarbeitung von 
    ...
    #j: Ja
        @Maßnahmen >> Versionsabhängige Formate:
