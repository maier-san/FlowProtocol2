...
Ein Blick in der Adresszeile des Browsers zeigt, dass die Antwort auf die Frage bei Wahl von \emph{Hallo Welt} als Parametersequenz \lstinline|Q=h| in der URL gespeichert wurde. Das ist auch der einzige Ort, wo sich diese Information wiederfindet, denn \FPZ\ selbst speichert keine Eingabedaten auf Serverseite. Die beiden Buchstaben \lstinline|Q| und \lstinline|h|, bzw.\ \lstinline|a| sind hierbei durch den Skriptcode festgelegt und heißen Schlüssel\index{Schlüssel}. 
...
Da die Gesamtlänge der URL für Seitenaufrufe auch unter den Komponenten mit maximaler EInschränkung auf knapp über 2000 Zeichen begrenzt ist, muss man sich über die Länge von Schlüsseln erst Gedanken machen, wenn man wirklich viele Auswahlabfragen in ein Skript einbaut.
...
Ergänzend dazu gibt es in Kapitel~\ref{Befehlsreferenz} ebenfalls eine Befehlsreferenz, die alle Befehle auf\-listet, und auch auf deren Verwendung in dieser Dokumentation hier verweist.
