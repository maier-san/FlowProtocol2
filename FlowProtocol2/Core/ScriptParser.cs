namespace FlowProtocol2.Core
{
    ...
    public class ScriptParser
    {
        ...
        private void LoadCommands()
        {
            ...
            CmdParser.Add(CmdFor.GetComandParser());
            ...
            CmdParser.Add(CmdAddToList.GetComandParser());
            ...
            CmdParser.Add(CmdDateSet.GetComandParser());
            ...
            CmdParser.Add(CmdClearVar.GetComandParser());
            CmdParser.Add(CmdSort.GetComandParser());
            CmdParser.Add(CmdRegExReplace.GetComandParser());
            CmdParser.Add(CmdXmlEncode.GetComandParser());
